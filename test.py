...
sheet.append(['Account ID', 'CompanyNo', 'Website', 'Contact', 'Email', 'Phone', 'Assets'])
...
with ThreadPoolExecutor(max_workers=20) as executor:
    ...
    for future in as_completed(futures):
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=20) as data_executor:
...
workbook.save("account_details.xlsx")